    ...
    <div class="container">
        ...
        <div class="card text-center mt-5 f-black">
            <div class="card-header">
                <p>EduConnect</p>
                <br>
                <p class="letter-cap text-left">Quer ganhar mais 150 pontos para usar na Loja do game?<br><br>

                    É só clicar no botão abaixo e realizar o download do App EduConnect!<br><br>

                    <b>O que é o EduConnect?</b><br><br>
                    É um App para facilitar o acesso a alguns serviços da Universidade, a Católica de Brasília (UCB). Faça o download e acesse informações do Graduação Online de forma rápida e prática. Inicie solicitações, visualize notificações, comunicados, avisos e muito mais!
                </p><br>
                <div class="row fora">
                    <div class="col-12">
                        <a href="eduConnect.php">
                            <img src="../../pix/education.png">
                            <p class="letter-cap">Baixar o aplicativo!</p>
                        </a>
                    </div>
                </div>
            </div>
